                ...
                if(cursor){
                    ...
                    listadoClientes.innerHTML += `
                        <tr>
                            ...
                            <td class="px-7 py-4 whitespace-no-wrap border-b border-gray-200 text-sm leading-5">
                                <a href="editContactForm.html?id=${id}" class="text-teal-600 hover:text-teal-900 mr-5">Editar</a>
                                <a href="email.html?id=${id}" class="text-blue-600 hover:text-blue-900 mr-5">Enviar Correo</a>
